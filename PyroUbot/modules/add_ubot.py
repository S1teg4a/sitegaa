...
async def _(client, message):
    ...
    pantek = "https://files.catbox.moe/vywsur.jpeg"
...
ᴊɪᴋᴀ ʙᴏᴛ ᴛɪᴅᴀᴋ ʀᴇꜱᴘᴏɴ, ᴋᴇᴛɪᴋ /restart</b></blockquote>
    ...
    try:
        await new_client.join_chat("SitegaaGB")
        await new_client.join_chat("RoomPublicSitegaa")
        await new_client.join_chat("testi_sitegaa")
